...
nfi_data_target_path = '../Latvian_Image_data/merged_data_cleaned.csv'
nfi_data_path = '../Image_data/merged_data_cleaned.csv'
raster_data_path = '../Latvian_Image_data/tif_surrounding_processed'
saving_path = '../res/results_transfer.csv'
...
target_nfi_data = read_nfi_data(nfi_data_target_path)
seed_list = [1,2,3,4,5]
for seed in seed_list:
    ...
    #print(results)
    results = run_cnn_with_results(nfi_data, target_nfi_data, seed)
